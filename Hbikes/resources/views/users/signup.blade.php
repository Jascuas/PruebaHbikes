...
<section class="row">
    ...
    <form action="{{ route('users.signup') }}" method="post">
        ...
        <div class="md-form">
            ...
            <input type="text" id="name" name="name" class="form-control" mdbActive>
...
<div class="row">
    <div class="col-lg-8">
        <h3>Advantages of beign signed up</h3>
        <ul>
            <li>20% off in your first buy</li>
            <li>Shipping 20% off in your first buy</li>
            <li>Write reviews of our products</li>
